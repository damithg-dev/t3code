...
describe("resolveMarkdownFileLinkTarget", () => {
  ...
  it("resolves a non-anchor repo root for a multi-repo file (#923)", () => {
    expect(
      resolveMarkdownFileLinkMeta("/work/backend/src/api.ts", "/work/anchor", undefined, [
        "/work/frontend",
        "/work/backend",
      ]),
    ).toMatchObject({
  ...
  it("prefers the most specific root when roots are nested", () => {
    expect(
      resolveMarkdownFileLinkMeta("/work/repo/packages/ui/index.ts", "/work/anchor", undefined, [
        "/work/repo",
  ...
  it("leaves fileRoot unset when no repo root claims the path", () => {
    expect(
      resolveMarkdownFileLinkMeta("/work/anchor/notes.md", "/work/anchor", undefined, [
        "/work/backend",
      ]),
    ).toMatchObject({
