...
export default function DiffPanel({
  ...
  // Refresh once per workspace-mutating provider event. `refreshGitDiff` rather
  // than the branch preview alone so a multi-repo workspace's per-repo sections
  // pick the change up through the refresh token too.
