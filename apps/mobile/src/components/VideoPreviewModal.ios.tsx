...
/**
 * AVKit plays every video. Copy, open, save, and share live on the chip or
 * thumbnail that opened it, so the player needs no menu. It gives no retry
 * either: a failed mint alerts and closes, and the next open mints again.
 */
