...
/** Streams from a signed URL, re-minting it on explicit play and retry. */
...
/** Leases the draft's file for as long as the player is open; sharing copies from that lease. */
