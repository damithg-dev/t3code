...
/** A composer draft: its bytes come from a file the viewer leases while open. */
...
/** A sent attachment streams like any other media, through its attachment asset resource. */
