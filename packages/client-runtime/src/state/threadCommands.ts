...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    dequeueTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:dequeue-turn",
      execute: (input: DequeueThreadTurnInput) => dequeueThreadTurn(input),
      scheduler,
      concurrency,
    }),
